...
--------------------------------------------------------------------------------
# 371 "Sort.hs"
sat_unq_n02 xs ys = question (stoogesort2 xs === stoogesort2 ys .&&. xs =/= ys .&&. zunique xs .&&. length xs === (S (S Z)) .&&. length ys === (S (S Z)))
sat_unq_n03 xs ys = question (stoogesort2 xs === stoogesort2 ys .&&. xs =/= ys .&&. zunique xs .&&. length xs === (S (S (S Z))) .&&. length ys === (S (S (S Z))))
sat_unq_n04 xs ys = question (stoogesort2 xs === stoogesort2 ys .&&. xs =/= ys .&&. zunique xs .&&. length xs === (S (S (S (S Z)))) .&&. length ys === (S (S (S (S Z)))))
sat_unq_n05 xs ys = question (stoogesort2 xs === stoogesort2 ys .&&. xs =/= ys .&&. zunique xs .&&. length xs === (S (S (S (S (S Z))))) .&&. length ys === (S (S (S (S (S Z))))))
sat_unq_n06 xs ys = question (stoogesort2 xs === stoogesort2 ys .&&. xs =/= ys .&&. zunique xs .&&. length xs === (S (S (S (S (S (S Z)))))) .&&. length ys === (S (S (S (S (S (S Z)))))))
sat_unq_n07 xs ys = question (stoogesort2 xs === stoogesort2 ys .&&. xs =/= ys .&&. zunique xs .&&. length xs === (S (S (S (S (S (S (S Z))))))) .&&. length ys === (S (S (S (S (S (S (S Z))))))))
sat_unq_n08 xs ys = question (stoogesort2 xs === stoogesort2 ys .&&. xs =/= ys .&&. zunique xs .&&. length xs === (S (S (S (S (S (S (S (S Z)))))))) .&&. length ys === (S (S (S (S (S (S (S (S Z)))))))))
sat_unq_n09 xs ys = question (stoogesort2 xs === stoogesort2 ys .&&. xs =/= ys .&&. zunique xs .&&. length xs === (S (S (S (S (S (S (S (S (S Z))))))))) .&&. length ys === (S (S (S (S (S (S (S (S (S Z))))))))))
sat_unq_n10 xs ys = question (stoogesort2 xs === stoogesort2 ys .&&. xs =/= ys .&&. zunique xs .&&. length xs === (S (S (S (S (S (S (S (S (S (S Z)))))))))) .&&. length ys === (S (S (S (S (S (S (S (S (S (S Z)))))))))))
