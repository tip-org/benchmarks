...
(define-funs-rec
  ((par (a4) (rev ((x2 (list a4))) (list a4))))
  ((match x2
     (case nil x2)
     (case
       (cons x3 xs2)
       (append (as (rev xs2) (list a4)) (cons x3 (as nil (list a4))))))))
(define-funs-rec
  ((par
     (a5) (qrevflat ((x4 (list (list a5))) (x5 (list a5))) (list a5))))
  ((match x4
     (case nil x5)
     (case
       (cons xs3 xss2)
...
(define-funs-rec
  ((par (a2) (revflat ((x (list (list a2)))) (list a2))))
  ((match x
