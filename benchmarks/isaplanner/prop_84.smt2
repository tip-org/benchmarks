...
(define-funs-rec
  ((par
     (a6)
     (append
        ((x8 (list a6)) (x9 (list a6))) (list a6)
        (match x8
          (case nil x9)
          (case
            (cons x10 xs2) (cons x10 (as (append xs2 x9) (list a6)))))))))
(declare-sort a7 0)
(declare-sort a8 0)
(assert
  (not
    (forall
      ((xs3 (list a7)) (ys (list a8)) (zs (list a8)))
      (=
        (zip xs3 (append ys zs))
        (append
          (zip (take (len ys) xs3) ys) (zip (drop (len ys) xs3) zs))))))
(check-sat)
