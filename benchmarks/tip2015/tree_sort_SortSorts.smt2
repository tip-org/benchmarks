  ...
  ((match x13
     ...
     (case
       ...
       (match x14
         ...
         (case (S d2) (le d d2)))))))
(define-funs-rec
  ((par (a3) (flatten ((x8 (Tree a3)) (x9 (list a3))) (list a3))))
  ((match x8
     (case
       (Node p2 x10 q)
...
(define-funs-rec
  ((add ((x11 Nat) (x12 (Tree Nat))) (Tree Nat)))
  ((match x12
     (case
       (Node p3 y2 q2)
       (ite
