...
(define-funs-rec
  ((par (a3 b) (fmap ((x3 (=> a3 b)) (x4 (list a3))) (list b))))
  ((match x4
     (case nil (as nil (list b)))
     (case
       (cons x5 xs2) (cons (@ x3 x5) (as (fmap x3 xs2) (list b)))))))
(define-funs-rec
  ((par (a5) (append ((x9 (list a5)) (x10 (list a5))) (list a5))))
  ((match x9
     (case nil x10)
     (case (cons x11 xs4) (cons x11 (as (append xs4 x10) (list a5)))))))
(define-funs-rec
  ((par
     (a4 b2) (bind ((x6 (list a4)) (x7 (=> a4 (list b2)))) (list b2))))
  ((match x6
