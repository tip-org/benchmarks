...
(define-funs-rec ((or2 ((x6 bool) (x7 bool)) bool (ite x6 x6 x7))))
(define-funs-rec
  ((par
     (a3)
     (null
...
(define-funs-rec
  ((insert2
      ((x21 Nat) (x22 Heap)) Heap (merge (Node Nil x21 Nil) x22))))
(define-funs-rec
  ((toHeap
      ((x14 (list Nat))) Heap
      (match x14
...
(define-funs-rec
  ((par
     (b c a2)
     (dot ((x3 (=> b c)) (x4 (=> a2 b)) (x5 a2)) c (@ x3 (@ x4 x5))))))
(define-funs-rec
  ((hsort
      ((x23 (list Nat))) (list Nat)
      (dot
        (lambda ((x24 Heap)) (toList2 x24))
        (lambda ((x25 (list Nat))) (toHeap x25)) x23))))
(define-funs-rec
  ((delete
      ((x29 Nat) (x30 (list Nat))) (list Nat)
      (match x30
        (case nil x30)
        (case
          (cons y2 ys2)
...
(define-funs-rec
  ((isPermutation
      ((x18 (list Nat)) (x19 (list Nat))) bool
      (match x18
        (case nil (null x19))
        (case
          (cons x20 xs2)
