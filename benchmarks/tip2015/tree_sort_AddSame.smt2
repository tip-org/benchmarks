...
(assert
  (not
    (forall
      ((x13 Nat) (t (Tree Nat)))
      (=
        (count x13 (flatten (add x13 t) (as nil (list Nat))))
        (S (count x13 (flatten t (as nil (list Nat)))))))))
(check-sat)
