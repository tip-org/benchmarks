...
(define-fun
  ...
  (match x
    ((nil (match (halve y) (((pair2 as1 bs) (Q2 (reverse as1) bs)))))
     ((cons z x2)
      (match y
        ((nil (match (halve x) (((pair2 as12 cs) (Q2 as12 (reverse cs))))))
         ((cons x3 x4) (Q2 x y))))))))
(define-fun
  +++
  ...
  (match x
    (((Q2 xs ys)
      (match y
        (((Q2 vs ws) (mkQ (++ xs (reverse ys)) (++ ws (reverse vs))))))))))
(define-fun
  deqL
